...
-- Executar consultas individuais para cada tabela é um processo trabalhoso e não facilita a comparação direta entre os 
-- resultados obtidos.

-- Desenvolva uma solução que permita visualizar a quantidade de registros de várias tabelas em uma única consulta, 
-- consolidando os resultados em uma tabela única. Isso irá otimizar o processo de verificação e comparação, tornando-o 
